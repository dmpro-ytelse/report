...
The Energy Micro Application Note on Fat and SD cards \todo{cite the application note}, and its example code, describes an implementation of the FatFS library on the Giant Gecko micro controller.

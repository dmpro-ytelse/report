...
Since the instruction memory stores 32 bits per address, (see section \ref{subsec:fpga-instruction-memory} for more details on the instruction memory) there are two states for accessing instruction memory, either the upper or the lower half.

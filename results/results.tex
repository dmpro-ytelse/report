...
\begin*{figure}[H]
\lstinputlisting[language=Python, caption={Genetic problem}]{continuous-ga-test/problems.py}
\label{problems-ga}
\end{figure}

\subsubsection{Solvers}
\begin*{figure}[H]
\lstinputlisting[language=Python, caption={Generational and steady state solvers}]{continuous-ga-test/solvers.py}
\label{solvers-ga}
\end{figure}

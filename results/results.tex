...
\lstinputlisting[language=Python, caption={Genetic problem}]{continuous-ga-test/problems.py} \label{problems-ga}

\subsubsection{Solvers}
\lstinputlisting[language=Python, caption={Generational and steady state solvers}]{continuous-ga-test/solvers.py} \label{solvers-ga}

...
Communication between the different, possibly hetereogeneous independent computing units is either done by message passing, or sharing memory between processors.
...
\begin{center}
    ...
    Block-level overview of a MIMD computer with a shared memory model.
    \todo{footnotes inside figures don't work. Find some other way to indicate where the illustration was taken from}
   % \footnote{http://en.wikipedia.org/wiki/File:MIMD.svg }
   }
\end{center}
\end{figure}
...
\todo{someone should read over this}


\subsection{Continuous Genetic Algorithms}
A new and better strategy is gaining traction in the literature.\TODO{TODO: find a citation for this}.\todo{what literature?}
...
This erases the generational border, and has been shown to converge faster towards an optimal solution\TODO{TODO:cite our own research here, plus literature}.

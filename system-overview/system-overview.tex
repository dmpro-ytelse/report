...
The SCU, or System Control Unit, is an energy micro micro controller \todo{version number etc} which administrates communication between the FPGA and the outside world.

...
As is shown in figure x\cn\todo{ref the architecture figure}, the genetics accelerator has its own data buses connected to the fitness cores separate from the data bus that is connected to the regular shared data memory.
...
The state machine can be seen in figure \ref{fpga:fig:mem:genetic_memory_ctrl}.\cn

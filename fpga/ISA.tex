...
%%This makes the construction of the data path a lot simpler, since it does not rely on any advance logic to decode and execute the instructions. Which result in a simpler pipeline architecture. 

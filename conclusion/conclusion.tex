...
Our goal of constructing a general MIMD computer capable of solving hard problems using genetic algorithms was met.\todo{this should probably be elaborated on}

\todo{IO: receive instructions? FR4}

\todo{fpga: maximized performance?}

\todo{fpga: mention the instruction set}
...
The system's 3D-printed case is pretty neat and a complete Barricelli system can fit inside of it. \todo{Rune: vil du skrive en setning til her?}

\todo{working demo program? see nfr6}

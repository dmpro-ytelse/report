\section{Design choices} \label{pcb:design-choices}
...
\todo{someone that's not Odd should read over this}
...
The EFM32GG390 was chosen because it was deemed powerful enough to satisfy the performance requirements and had the highest number of available general purpose I/O (GPIO) pins amongst the microcontrollers with the same kind of package.
